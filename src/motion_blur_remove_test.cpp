...
int main(int argc, char *argv[])
{
    ...
    int LEN = 100;//parser.get<int>("LEN");
    double THETA = 2;//parser.get<double>("THETA");
    int snr = 10;//parser.get<int>("SNR");
    string strInFileName = "/home/argus/Downloads/Image5042.jpg";//parser.get<String>("image");
    if (!parser.check())
    {
        parser.printErrors();
        return 0;
