#ifndef 	VISUAL_SYSTEM_VISION_SYSTEM_HPP
#define 	VISUAL_SYSTEM_VISION_SYSTEM_HPP
...
/**
 * @brief клаCс хранит в себе изображение , и его параметры 
 * 
 */
class VisionSystem
{	
	public:
		...
		VectorXd_t 	getCamPosition(cv::Vec3d &rvec, cv::Vec3d &tvec);
		void 		updateImage();
